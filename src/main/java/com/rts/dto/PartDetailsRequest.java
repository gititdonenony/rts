...
public class PartDetailsRequest {
    ...
    public BigDecimal getPartiallyAmountPaid() {
        return partiallyAmountPaid;
    }

    public void setPartiallyAmountPaid(BigDecimal partiallyAmountPaid) {
        this.partiallyAmountPaid = partiallyAmountPaid;
    }
    ...
    public String getMilesPromised() {
        return milesPromised;
    }

    public void setMilesPromised(String milesPromised) {
        this.milesPromised = milesPromised;
    }
